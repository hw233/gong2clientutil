#!/bin/bash
SVN="svn --username=GJMAC-1 --password=123456"
...
DATA_CSV_URL="$PROJECT_PREFIX/design/csv"
DATA_CLIENT_URL="$PROJECT_PREFIX/gongclient/trunk/gong2/src/app/config/data"
DATA_SERVER_URL="$PROJECT_PREFIX/gongserver/trunk/gong-game/src/main/java/com/gamejelly/gong/config/data"
