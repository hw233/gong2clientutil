...
data.map(
    ...
    4, map("id", 4, "name", "家园繁荣度", "funName", "factionsA", "kind", 0),
    5, map("id", 5, "name", "权贵所属方派系影响力", "funName", "factionsB", "kind", 0)
);
    }

    private static void init1() {
data.map(
    6, map("id", 6, "name", "我方派系影响力", "funName", "factionsC", "kind", 0),
    7, map("id", 7, "name", "平均官阶", "funName", "factionsD", "kind", 0),
    8, map("id", 8, "name", "响应人数", "funName", "factionsE", "kind", 0),
...
data.map(
    ...
    10059, map("id", 10059, "name", "暴击率", "funName", "equCri", "kind", 0),
    10060, map("id", 10060, "name", "抗暴率", "funName", "equDcri", "kind", 0),
    10061, map("id", 10061, "name", "暴击伤害百分比", "funName", "equFocus", "kind", 0),
    10062, map("id", 10062, "name", "破招", "funName", "equDparry", "kind", 0)
);
    }

    private static void init14() {
data.map(
    10063, map("id", 10063, "name", "招架", "funName", "equParry", "kind", 0),
    10064, map("id", 10064, "name", "招架伤害百分比", "funName", "equTen", "kind", 0),
    10065, map("id", 10065, "name", "忽视防御", "funName", "equPen", "kind", 0),
    80027, map("id", 80027, "name", "总攻击值", "funName", "totAtk", "prop", "atkLv*lv+rankAtk+equAtk", "kind", 1),
...
data.map(
    80029, map("id", 80029, "name", "总物防值", "funName", "totDef", "prop", "defLv*lv+rankDef+equDef", "kind", 1),
    80030, map("id", 80030, "name", "总物防百分比", "funName", "totPreDef", "prop", "basPreDef+equPreDef+1", "kind", 1),
    80031, map("id", 80031, "name", "总法防值", "funName", "totDpower", "prop", "rankDpower+equDpower+dpowerLv*lv", "kind", 1),
    80032, map("id", 80032, "name", "总法防百分比", "funName", "totPreDpower", "prop", "basPreDpower+equPreDpower+1", "kind", 1),
    80033, map("id", 80033, "name", "总生命值", "funName", "totHp", "prop", "rankHp+equHp+lv*hpLv", "kind", 1)
);
    }
...
data.map(
    ...
    80036, map("id", 80036, "name", "暴击率", "funName", "totCri", "prop", "basCri+equCri", "kind", 1),
    80037, map("id", 80037, "name", "抗暴率", "funName", "totDcri", "prop", "basDcri+equDcri", "kind", 1),
    80038, map("id", 80038, "name", "暴击伤害百分比", "funName", "totFocus", "prop", "basFocus+0.5+equFocus", "kind", 1)
);
    }

    private static void init17() {
data.map(
    80039, map("id", 80039, "name", "无视格挡率", "funName", "totDparry", "prop", "basDparry+equDparry", "kind", 1),
    80040, map("id", 80040, "name", "格挡率", "funName", "totParry", "prop", "basParry+equParry", "kind", 1),
    80041, map("id", 80041, "name", "格挡伤害百分比", "funName", "totTen", "prop", "basTen+0.3+equTen", "kind", 1),
...
data.map(
    ...
    80047, map("id", 80047, "name", "面板攻击值", "funName", "disAtk", "prop", "math.floor(basAtk+totAtk*totPreAtk)", "kind", 1),
    80048, map("id", 80048, "name", "面板物防值", "funName", "disDef", "prop", "math.floor(basDef+totDef*totPreDef)", "kind", 1)
);
    }

    private static void init19() {
data.map(
    80049, map("id", 80049, "name", "面板法防值", "funName", "disDpower", "prop", "math.floor(basDpower+totDpower*totPreDpower)", "kind", 1),
    80050, map("id", 80050, "name", "面板生命值", "funName", "disHp", "prop", "math.floor(basHp+totHp*totPreHp)", "kind", 1),
...
data.map(
    ...
    80058, map("id", 80058, "name", "面板增伤值", "funName", "disDeHIT", "prop", "math.floor(totDeHIT)", "kind", 1)
);
    }

    private static void init21() {
data.map(
    80059, map("id", 80059, "name", "面板减伤值", "funName", "disEahit", "prop", "math.floor(totEahit)", "kind", 1),
