...
DATA_CSV_URL="$PROJECT_PREFIX/gong2design/branches/gong2design_hd/trunk/csv"
DATA_CLIENT_URL="$PROJECT_PREFIX/gong2client/branches/gong2client_hd/trunk/gong2/src/app/config/data"
DATA_SERVER_URL="$PROJECT_PREFIX/gong2server/branches/gong2server_hd/trunk/gong2-game/src/main/java/com/gamejelly/gong2/config/data"
