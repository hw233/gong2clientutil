    ...
    <body>
        <div class="m_design">
            <div class="page-header">
                <h2>发布各平台Beta客户端
                    <button id="buildClientScript" class="btn btn-info" type="button" onclick="${remoteFunction(action:'updateTools',onSuccess:'onUpdateTools(data)',onFailure:'onUpdateTools(false)')}">更新策划工具</button>
                </h2>
            </div>
            <p>
            ...
            <p>
                ...
                <a href="http://183.232.28.148/apps/${sdk.opr}" target="_blank">下载地址: ${sdk.name} (${sdk.opr})</a>
            </p>
            </g:each>
